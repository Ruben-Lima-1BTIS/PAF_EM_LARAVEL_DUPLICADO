...
<h2 class="text-xl font-bold mb-2 mt-10">Criar Utilizador</h2>
...
<h2 class="text-xl font-bold mb-2 mt-10">Criar Turma</h2>
...
<h2 class="text-xl font-bold mb-2 mt-10">Criar Estágio</h2>
...
<h2 class="text-xl font-bold mb-2 mt-10">Atribuir Estágio a Utilizador</h2>
...
roleSelectUser.addEventListener('change', updateFieldsUser);
updateFieldsUser();
</script>
